<section class="py-24 px-4 max-w-5xl mx-auto {{ $sectionData['visible'] ? '' : 'hidden' }}"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div class="card-eldoria p-6 text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <h3 class="font-display text-text-primary font-semibold mb-2" data-default-text="{{ __('theme::theme.home.join_step2_title') }}">{{ $sectionData['steps'][1]['title'] ?: __('theme::theme.home.join_step2_title') }}</h3>
            <p class="text-text-secondary text-sm" data-default-text="{{ __('theme::theme.home.join_step2_text') }}">{{ $sectionData['steps'][1]['text'] ?: __('theme::theme.home.join_step2_text') }}</p>
        </div>
        <div class="card-eldoria p-6 text-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <h3 class="font-display text-text-primary font-semibold mb-2" data-default-text="{{ __('theme::theme.home.join_step3_title') }}">{{ $sectionData['steps'][2]['title'] ?: __('theme::theme.home.join_step3_title') }}</h3>
            <p class="text-text-secondary text-sm" data-default-text="{{ __('theme::theme.home.join_step3_text') }}">{{ $sectionData['steps'][2]['text'] ?: __('theme::theme.home.join_step3_text') }}</p>
        </div>
    </div>
</section>
